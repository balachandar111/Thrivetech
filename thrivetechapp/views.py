...
def home(request):
    if request.method == 'POST':
        ...
        """
        recipient_email = ['pronkbalaji@gmail.com']  # Replace with the recipient's email
...
def form(request):
     if request.method == 'POST':
        ...
        recipient_list = ['pronkbalaji@gmail.com']  # Replace with the recipient's email
        sender = 'balachandarsanthoshkumar111.com'  # Replace with the sender's email (configured in Django settings)
